...
// Static fallback tech-tree positions extracted from the Freeciv C client.
// Used only when store.computedReqtree is null (before RULESET_READY fires).
// In practice the dynamic layout (reqtreeLayout.ts) is always preferred.
...
export const reqtree: { [key: string]: ReqTreeNode } = {
  "2": { "x": 0, "y": 0 }, // Alphabet
