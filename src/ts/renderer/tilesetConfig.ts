...
export const tileset_options: string = "+tilespec4+2007.Oct.26";

// A simple name for the tileset specified by this file:
export const tileset_name: string = "amplio2";
export const priority: number = 20;

export const tileset_image_count: number = 3;

export const normal_tile_width: number = 96;
export const normal_tile_height: number = 48;
export const small_tile_width: number = 15;
export const small_tile_height: number = 20;

export const is_hex: number = 0;
export const is_isometric: number = 1;


// Do not blend hills and mountains together.
export const is_mountainous: number = 0;

// Use roadstyle 0 (old iso style)
export const roadstyle: number = 0;

// Fogstyle 2, darkness_style 4 : blended fog
export const fogstyle: number = 2;
export const darkness_style: number = 4;

// offset the flags by this amount when drawing units
export const unit_flag_offset_x: number = 25;
export const unit_flag_offset_y: number = 16;
export const city_flag_offset_x: number = 2;
export const city_flag_offset_y: number = 9;

export const city_size_offset_x: number = 0;
export const city_size_offset_y: number = 20;

export const unit_activity_offset_x: number = 55;
export const unit_activity_offset_y: number = 25;

// offset the units by this amount when drawing units
export const unit_offset_x: number = 19;
export const unit_offset_y: number = 14;

// Enable citybar
export const is_full_citybar: number = 1;

// offset the citybar text by this amount (from the city tile origin)
export const citybar_offset_y: number = 55;
export const citybar_offset_x: number = 45;

// offset the tile label by this amount (from the city tile origin)
export const tilelabel_offset_y: number = 15;
export const tilelabel_offset_x: number = 0;
