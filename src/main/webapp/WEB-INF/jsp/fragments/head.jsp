...
%>
<title>${empty title ? "XBWorld - AI-powered civilization strategy game" : title}</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<meta name="author" content="XBWorld">
<meta name="description" content="Play XBWorld online - an AI-powered civilization strategy game with 2D HTML5 or 3D WebGL in your browser, tablet or mobile device!">
...
<style>
	...
	.panel-xbworld h1, .panel-xbworld h2, .panel-xbworld h3,
	.panel-xbworld h4, .panel-xbworld h5, .panel-xbworld h6 {
		margin-top: 0px;
	}
	/*
