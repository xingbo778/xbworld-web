...
function show_longturn_intro_dialog() {
  ...
  var title = "Welcome to XBWorld: One Turn per Day!";

  var message = "<br>This is a XBWorld: One Turn per Day game, which is a XBWorld multiplayer game "+
...
function show_new_user_account_dialog(gametype)
{
  ...
  var message = "Create a new XBWorld user account with information about yourself:<br><br>"
