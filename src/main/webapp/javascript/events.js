/***********************************************************************
 * events.js — Event type constants for the Freeciv message log system.
 *
 * Extracted from webclient.min.js during Phase 4→5 migration.
 * These constants were previously bundled in the minified file and
 * are required by client_main.js, messages.js, and other modules.
 ***********************************************************************/
...
var fc_e_section_names = ["e_s_advance", "e_s_build", "e_s_city", "e_s_d_me", "e_s_d_them", "e_s_global", "e_s_hut", "e_s_nation", "e_s_treaty", "e_s_unit", "e_s_vote", "e_s_wonder", "e_s_xyzzy", "e_s_chat"];
var fc_e_section_descriptions = ["Technology", "Improvement", "City", "Diplomat Action", "Enemy Diplomat", "Global", "Hut", "Nation", "Treaty", "Unit", "Vote", "Wonder", "Misc", "Chat"];

/* Event type constants (0–142) */
