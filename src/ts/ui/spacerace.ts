...
export const SSHIP_NONE: number = 0;
export const SSHIP_STARTED: number = 1;
export const SSHIP_LAUNCHED: number = 2;
export const SSHIP_ARRIVED: number = 3;

export const SSHIP_PLACE_STRUCTURAL: number = 0;
export const SSHIP_PLACE_FUEL: number = 1;
export const SSHIP_PLACE_PROPULSION: number = 2;
export const SSHIP_PLACE_HABITATION: number = 3;
export const SSHIP_PLACE_LIFE_SUPPORT: number = 4;
export const SSHIP_PLACE_SOLAR_PANELS: number = 5;

/**************************************************************************
 ...
**************************************************************************/
export function show_spaceship_dialog(): void {
  const title: string = "Spaceship";
  let message: string = "";
  ...
  const spaceship: any = spaceship_info[client.conn.playing['playerno']];
  ...
  if (spaceship['sship_state'] != SSHIP_STARTED || spaceship['success_rate'] == 0) {
    $(".ui-dialog-buttonpane button:contains('Launch')").button("disable");
  }
}
...
/**************************************************************************
 ...
**************************************************************************/
export function launch_spaceship(): void {
  const test_packet: any = {"pid" : packet_spaceship_launch};
  const myJSONText: string = JSON.stringify(test_packet);
...
/**************************************************************************
 ...
**************************************************************************/
export function get_spaceship_state_text(state_id: number): string | undefined {
