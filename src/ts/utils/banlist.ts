...
*/
export const banned_users: string[] = [];

/**************************************************************************
 Returns false if the text contains a banned user.
**************************************************************************/
export function check_text_with_banlist(text: string | null): boolean {
...
/**************************************************************************
 Returns false if the text contains a banned user.
**************************************************************************/
export function check_text_with_banlist_exact(text: string | null): boolean {
  if (text == null || text.length === 0) return false;
  for (let i = 0; i < banned_users.length; i++) {
