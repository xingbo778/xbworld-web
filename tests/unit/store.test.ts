...
describe('GameStore', () => {
  ...
  it('should find city by id', () => {
    store.cities[42] = {
      id: 42, owner: 0, tile: 100, name: 'Rome', size: 5,
  ...
  it('should find unit by id', () => {
    store.units[7] = {
      id: 7, owner: 0, tile: 50, type: 1, hp: 10, veteran: 0,
  ...
  it('should find player by id', () => {
    store.players[0] = {
      playerno: 0, name: 'Player 1', username: 'p1', nation: 5,
      is_alive: true, is_ready: true, ai_skill_level: 0,
      gold: 100, tax: 30, luxury: 20, science: 50,
