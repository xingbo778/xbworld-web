...
export const VUT_ADVANCE = 1;
export const VUT_GOVERNMENT = 2;
export const VUT_IMPROVEMENT = 3;
export const VUT_TERRAIN = 4;
export const VUT_NATION = 5;
export const VUT_UTYPE = 6;
export const VUT_UTFLAG = 7;
export const VUT_UCLASS = 8;
export const VUT_UCFLAG = 9;
export const VUT_OTYPE = 10;
export const VUT_SPECIALIST = 11;
export const VUT_MINSIZE = 12;
export const VUT_AI_LEVEL = 13;
export const VUT_TERRAINCLASS = 14;
export const VUT_MINYEAR = 15;
export const VUT_TERRAINALTER = 16;
export const VUT_CITYTILE = 17;
export const VUT_GOOD = 18;
export const VUT_TERRFLAG = 19;
export const VUT_NATIONALITY = 20;
export const VUT_BASEFLAG = 21;
export const VUT_ROADFLAG = 22;
export const VUT_EXTRA = 23;
export const VUT_TECHFLAG = 24;
export const VUT_ACHIEVEMENT = 25;
export const VUT_DIPLREL = 26;
export const VUT_MAXTILEUNITS = 27;
export const VUT_STYLE = 28;
export const VUT_MINCULTURE = 29;
export const VUT_UNITSTATE = 30;
export const VUT_MINMOVES = 31;
export const VUT_MINVETERAN = 32;
export const VUT_MINHP = 33;
export const VUT_AGE = 34;
export const VUT_NATIONGROUP = 35;
export const VUT_TOPO = 36;
export const VUT_IMPR_GENUS = 37;
export const VUT_ACTION = 38;
export const VUT_MINTECHS = 39;
export const VUT_EXTRAFLAG = 40;
export const VUT_MINCALFRAG = 41;
export const VUT_SERVERSETTING = 42;
export const VUT_COUNT = 43;
