...
let action_selection_restart: boolean = false;
let did_not_decide: boolean = false;
...
**************************************************************************/
// This function is imported from clientState.ts, so it should not be exported here.
// export function select_tgt_unit(actor_unit: any, target_tile: any, potential_tgt_units: any[]): void {
//   let i: number;

//   const rid: string = "sel_tgt_unit_dialog_" + actor_unit['id'];
//   const id: string = "#" + rid;
//   let dhtml: string = "";
//   const buttons: any[] = [];
...
**************************************************************************/
// This function is imported from clientState.ts, so it should not be exported here.
// export function select_tgt_extra(actor_unit: any, target_unit: any,
//   target_tile: any, potential_tgt_extras: any[]): void {
//   let i: number;

//   const rid: string = "sel_tgt_extra_dialog_" + actor_unit['id'];
//   const id: string = "#" + rid;
//   let dhtml: string = "";
//   const buttons: any[] = [];
