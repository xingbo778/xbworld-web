<nav class="navbar navbar-inverse navbar-fixed-top">
	<div class="container">
		...
		<a class="navbar-brand" href="/">
			...
			<img src="/static/images/brand.png" alt="XBWorld">
		</a>
		</div>
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="http://forum.freegamedev.net/viewforum.php?f=97">XBWorld <fmt:message key="nav-forum"/></a></li>
					<li role="separator" class="divider"></li>
		...
		<form class="navbar-form navbar-right hidden-sm hidden-md" action="https://duckduckgo.com/" style="width: 220px;">
			...
			<div class="form-group">
				<div class="input-group">
					<input type="text" class="form-control" name="q" placeholder="Search XBWorld...">
